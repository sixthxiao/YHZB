...
public class FragmentLiveAttentionAdapter extends BaseRecyclerAdapter<TCVideoInfo> {


    private Context mContext;

    public FragmentLiveAttentionAdapter(@Nullable List<TCVideoInfo> data, Context context) {
        super(R.layout.item_home_attention, data);
        mContext = context;
