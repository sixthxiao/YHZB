...
public class CoolSwipeRefreshLayout extends ViewGroup {
    ...
    public interface RefreshCallback {
        void onDragPercentChange(float percent);
    }
    ...
    public RefreshDrawable getmRefreshDrawable() {
...
//        mRefreshView.measure(MeasureSpec.makeMeasureSpec(mRefreshViewWidth, MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(mRefreshViewHeight, MeasureSpec.EXACTLY));
    ...
    private void dragCallback() {
        if (callback != null) {
            callback.onDragPercentChange(mDragPercent);
        }
    }
