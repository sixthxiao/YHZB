...
import com.yahu.live.utils.ScreenUtils;

import de.hdodenhof.circleimageview.CircleImageView;


public class DragView extends CircleImageView {
    ...
    public static int getScreenWidth(Context var0) {
        @SuppressLint("WrongConstant") WindowManager var1 = (WindowManager)var0.getSystemService("window");
