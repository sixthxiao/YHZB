...
public class ToastUtil {
    ...
    public static void showToast(String text) {
        try {
            ...
            Looper.prepare();
            Toast toast1 = Toast.makeText(BaseApplication.getInstance(), text, Toast.LENGTH_SHORT);
    ...
    public static void showToastBot(String text) {
        try {
            ...
            //解决在子线程中调用Toast的异常情况处理
            Looper.prepare();
            Toast toast2 = Toast.makeText(BaseApplication.getInstance(), text, Toast.LENGTH_SHORT);
